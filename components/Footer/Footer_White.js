...
import logoMobile from './bimcopilot_logo_text_vertical_white_(2).svg';    
  ...
  render() {
    return (
      ...
      <Provider>
        ...
        <section id={styles.FOOTER_SECTION} class={styles.center_holder_white}>     
            <div class={styles.footer_holder_white}>
                <footer id={styles.FOOTER}>
                    <div id={styles.IPHONE_WHITE} class={styles.container}> 
                    ...
                    <div id={styles.OTHER} class={styles.container}>
                        ...
                        <div id={styles.SOCIAL}>
                         ...
                         <div id={styles.COMPANY_TEXT}>
                            <h4 id={styles._H4}  class=" text-xs ... text-stone-500 ...  font-avant_garde_bold text-right">Website by <a class="text-stone-700 font-avant_garde_bold">
                            <Link  href="/">designlab.pfbd</Link> 
                            </a>. Made with love, with a gun to our head.
                            </h4>
                            <br/>
